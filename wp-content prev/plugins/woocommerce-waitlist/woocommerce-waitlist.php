...
if ( ! class_exists( 'WooCommerce_Waitlist_Plugin' ) ) {
	...
	class WooCommerce_Waitlist_Plugin {
		...
		function wcwl_woocommerce_version_notice() {
			?>
			<div class="error">
				<p><?php _e( 'WooCommerce Waitlist is active but is not functional. This extension is not available with your version of WooCommerce. Please install and activate WooCommerce version 2.1 or higher.', 'woocommerce-waitlist' ); ?></p>
			</div>
			<?php
		}
