...
jQuery(document).ready(function() {
	...
	$j("#order-filter-select-all-payment").click(function(){

		$j('.jem-order-payment input').prop('checked', true);
		return false;
	});

	$j("#order-filter-select-none-payment").click(function(){

		$j('.jem-order-payment input').prop('checked', false);
		return false;
	});
	...
	$j('.jem-order-payment input[type=checkbox]').prop('checked', true);
