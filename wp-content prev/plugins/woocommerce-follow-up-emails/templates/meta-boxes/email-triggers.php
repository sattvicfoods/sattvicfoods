<div class="options_group">
    ...
    if ( $email->type == 'storewide' || $email->type == 'sensei' ):
    ...
    <div id="trigger_conditions" class="hide-if-date non-signup">
        ...
        if ( $email_conditions ):
            ...
            foreach ( $email_conditions as $idx => $email_condition ):
                ...
                <fieldset id="condition_<?php echo $idx; ?>">
                    ...
                    <a href="#" class="button btn-remove-condition">Delete Rule</a>
        ...
        <p>
            <a class="button button-primary btn-add-condition"><?php _e('Add Email Rule', 'follow_up_emails'); ?></a>
        </p>
    </div>
