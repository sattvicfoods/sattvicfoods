...
<table class="wp-list-table widefat fixed posts">
    ...
    ?>
        <tr scope="row">
            ...
            <td><?php echo ($opens > 0) ? __('<span class="dashicons dashicons-visibility" style="color:#7AD03A;"></span> Yes', 'follow_up_emails') : __('<span class="dashicons dashicons-visibility" style="color:#EEE;"></span> No', 'follow_up_emails'); ?></td>
