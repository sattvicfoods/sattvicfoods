...
= 5.2.0 =
* Don't ignore duplicate shipping classes entries. When mupltiple rates specified for a class in a rule, they all will be in effect starting from this version.
