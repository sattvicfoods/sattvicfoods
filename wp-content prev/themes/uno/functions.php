	...
	if( is_cart() || is_checkout() ) {
		...
		if( $total <= $minimum_cart_total  ) {
			wc_add_notice( sprintf( '<strong>A Minimum of 1 product(not Sample) is required before checking out order with Sample product.</strong>'
				.'<br />Please, <a href="https://13.127.121.242/shop/">continue shopping</a>',
				$minimum_cart_total,
...
function bbloomer_redirectcustom( $order_id ){
    ...
    $url = 'https://13.127.121.242/my-account/orders/';
...
wp_enqueue_style( 'font', 'https://13.127.121.242/wp-content/themes/uno/css/font.css',false,'1.1','all');
...
<h3 class="nav-toggle icon"><a href="#navigation" style="border:none;">Sattvic Foods</a></h3>
	...
	<a id= "cart-content-header" class="cart-contents" href="https//13.127.121.242/cart/" title="View your shopping cart"></a>
	<a class="icon_search_mobile" href="#">
	<i class="fa fa-search" aria-hidden="true">
	</i>	
	</a>
	<form class="search-header" id="search_mobile" role="search" action="https://13.127.121.242/" method="get">
...
<!-- <form id="search_mobile" role="search" action="https://13.127.121.242/" method="get">
