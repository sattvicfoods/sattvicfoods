jQuery(document).ready(function($){
	...
	// make column in one row with same height
		...
		if (document.addEventListener) {
			document.addEventListener('DOMContentLoaded', function() {
				heightsEqualizer('.related.products .products li.product a.woocommerce-LoopProduct-link'); 
				heightsEqualizer('.woocommerce ul.products li.product a.woocommerce-LoopProduct-link');
				heightsEqualizer('.woocommerce-cart #sidebar .up-sells.upsells.products li a.woocommerce-LoopProduct-link');
			});
