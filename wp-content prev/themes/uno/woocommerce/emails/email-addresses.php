			...
			<table style="border:none; padding:0; width:100%; margin: 0" >
				<tr>
					<td style="margin:0; padding:0; border:none; vertical-align:top;">
						<a href="https://13.127.121.242/my-account/edit-address/billing" class="edit">
							<img src="https://13.127.121.242/wp-content/uploads/2018/01/edit_address_icon.png" alt="">
						</a>
					</td>
					<td style="margin:0; padding:0; border:none">
						<a href="https://13.127.121.242/my-account/edit-address/billing" class="edit">Edit billing address for future orders only</a>
					</td>
				</tr>
			</table>
		</td>
		<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && ( $shipping = $order->get_formatted_shipping_address() ) ) : ?>
			<td class="td" style="text-align:left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" valign="top" width="50%">
				...
				<table style="border:none; padding:0; width:100%; margin: 0" >
					<tr>
						<td style="margin:0; padding:0; border:none; vertical-align:top;">
							<a href="https://13.127.121.242/my-account/edit-address/shipping" class="edit">
								<img src="https://13.127.121.242/wp-content/uploads/2018/01/edit_address_icon.png" alt="">
							</a>
						</td>
						<td style="margin:0; padding:0; border:none">
							<a href="https://13.127.121.242/my-account/edit-address/shipping" class="edit">Edit shipping address for future orders only</a>
						</td>
					</tr>
				</table>
			</td>
