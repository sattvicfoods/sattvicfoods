							...
							<?php } ?>
					  		<?php 
					  			...
					  			if ($order->shipping_phone) {
					  				$shipping_or_billing_phone = $order->shipping_phone;
					  			} else {
					  				$shipping_or_billing_phone = $order->billing_phone;
					  			}

					  		?>
								<p><?php _e('Tel:', 'woocommerce-pip'); ?><?php echo $shipping_or_billing_phone; ?></p>
					  ...
					  <div style="float:right; width: 49%;">
							...
							<div class="customer-address shipping-address">
								...
								<address class="customer-address">
									...
									<p><strong><?php _e('Tel:', 'woocommerce-pip'); ?></strong> <?php echo $order->shipping_phone; ?></p>
								    <?php endif; ?>
