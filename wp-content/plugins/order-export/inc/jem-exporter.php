...
class JEM_export_lite {
	...
	public function render_settings(){
		...
		$html = '<div class="wrap">
					<h2>Order Export</h2>' . $this->print_admin_messages() . '
	...
	function generate_fields_tab(){
		...
		$html .= '
			<p class="submit">
                ...
                // <input type="submit" class="button-primary"  id="submit-view" value="View ' . $object->id .'">'
...
//echo '<pre>'; print_r($ent); echo '</pre>';//exit;		
		if($ret === false){
