...
function fue_get_installed_templates() {
    ...
    $templates = array_filter( array_merge( $fue_templates, $theme_templates, $fue_subdir_templates, $theme_subdir_templates ) );
...
function fue_save_email( $args ) {
    ...
    if ( isset( $args['type'] ) ) {
        ...
        if ( !array_key_exists( $trigger, $email_triggers ) ) {
