...
class FUE_Install {
    ...
    public function install_notice() {
        ...
        if ( get_option( 'fue_needs_update' ) == 1 ) {
            ...
            <div id="message" class="updated">
                <p><?php _e( '<strong>Follow-Up Emails Data Update Required ('. get_option('fue_db_version') .' > '. Follow_Up_Emails::$db_version .')</strong>', 'follow_up_emails' ); ?></p>
    ...
    public function install() {
        ...
        if ( version_compare( $current_db_version, '7.14', '<' ) && null !== $current_db_version ) {
    ...
    public function update() {
        ...
        if ( version_compare( $db_version, '7.2', '<' ) ) {
            ...
            update_option( 'fue_db_version', '7.2' );
        }
        ...
        if ( version_compare( $db_version, '7.9', '<' ) ) {
            include( 'updates/update-7.9.php' );
            update_option( 'fue_db_version', '7.9' );
        }

        if ( version_compare( $db_version, '7.13', '<' ) ) {
            include( 'updates/update-7.13.php' );
            update_option( 'fue_db_version', '7.13' );
        }

        if ( version_compare( $db_version, '7.14', '<' ) ) {
            include( 'updates/update-7.14.php' );
            update_option( 'fue_db_version', '7.14' );
        }
