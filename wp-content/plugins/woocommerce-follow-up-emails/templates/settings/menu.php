<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
    ...
    <a href="admin.php?page=followup-emails-settings&amp;tab=crm" class="nav-tab <?php if ($tab == 'crm') echo 'nav-tab-active'; ?>"><?php _e('Permissions and Styling', 'follow_up_emails'); ?></a>
    ...
    <a href="admin.php?page=followup-emails-settings&amp;tab=auth" class="nav-tab <?php if ($tab == 'auth') echo 'nav-tab-active'; ?>"><?php _e('Authentication', 'follow_up_emails'); ?></a>
