...
?>
	...
	<div id="before_nav">
		...
		<?php /* } */ ?>
		<form id="searchform" role="search" action="https://sattvicfoods.in/" method="get" class="search_mobile">
...
?>
	<div class="side-nav">
		<div id="my_account_header" class="menu-item menu-item-type-post_type menu-item-object-page page_item"><a href="/my-account/" title="My Account" class="icon_login"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a><?php echo do_shortcode('[widgets_on_pages id="login"]'); ?></div>
<?php
...
function woo_footer_sidebars() {
	$settings = woo_get_dynamic_values( array( 'biz_disable_footer_widgets' => '', 'footer_sidebars' => '5' ) );

	$footer_sidebar_total = 5;
...
<section id="footer-widgets" class="col-full col-<?php echo esc_attr( intval( $total ) ); ?>">
  <div class="container">
	...
	<div class="footer-widget-<?php echo $i; ?> col-lg-2"> <!-- block -->
...
if ( ! function_exists( 'woo_header_widgetized' ) ) {
	...
	?>
	    <div class="header-widget">
	        <div class="header_part" id="logo_header"><?php woo_sidebar( 'header' ) ?></div>
	        <div class="header_part" id="india_pin_header"><?php echo do_shortcode('[widgets_on_pages id="Header 2"]'); ?></div>
	        <div class="header_part" id="free_shipping_header"><?php echo do_shortcode('[widgets_on_pages id="Header 3"]'); ?></div>
	        <div class="header_part" id="contacts_header"><?php echo do_shortcode('[widgets_on_pages id="Header 4"]'); ?></div>
			<!--<div class="header_part" id="contacts_header"><?php //echo  get_product_search_form(); ?> </div>-->
	    </div>
	<?php
	    }
	}
