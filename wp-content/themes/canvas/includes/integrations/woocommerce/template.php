	...
	function woo_custom_wc_search( $form ) {
		...
		$form = '<form role="search" method="get" id="searchform" action="' . esc_url( home_url( '/'  ) ) . '">
			<div>
				...
				<button type="submit" id="searchsubmit" class="fa fa-search submit" name="submit" value="' . __( 'Search', 'woothemes' ) . '" onsubmit="_gaq.push([\'_trackEvent\', \'Button\', \'Push\', \'search\']);"></button>
...
?>
	<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php _e( 'View your shopping cart', 'canvas' ); ?>">
		...
		<span class="count"><?php echo wp_kses_data( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'canvas' ), WC()->cart->get_cart_contents_count() ) );?></span> - <?php echo wp_kses_data( WC()->cart->get_cart_total() ); ?>
		<?php } ?>
	</a>
<?php
